    ...
    db.collection("FoodHistory").findOne(
      ...
      function (err, result) {
        ...
        if (result) {
          ...
          temp_val.breakfast.veggie = JSON.parse(
            JSON.stringify(result.breakfast.veggie)
          );
          temp_val.breakfast.fruits = JSON.parse(
            JSON.stringify(result.breakfast.fruits)
          );
          temp_val.breakfast.grains = JSON.parse(
            JSON.stringify(result.breakfast.grains)
          );
          temp_val.breakfast.protein = JSON.parse(
            JSON.stringify(result.breakfast.protein)
          );

          temp_val.lunch.veggie = JSON.parse(
            JSON.stringify(result.lunch.veggie)
          );
          temp_val.lunch.fruits = JSON.parse(
            JSON.stringify(result.lunch.fruits)
          );
          temp_val.lunch.grains = JSON.parse(
            JSON.stringify(result.lunch.grains)
          );
          temp_val.lunch.protein = JSON.parse(
            JSON.stringify(result.lunch.protein)
          );

          temp_val.dinner.veggie = JSON.parse(
            JSON.stringify(result.dinner.veggie)
          );
          temp_val.dinner.fruits = JSON.parse(
            JSON.stringify(result.dinner.fruits)
          );
          temp_val.dinner.grains = JSON.parse(
            JSON.stringify(result.dinner.grains)
          );
          temp_val.dinner.protein = JSON.parse(
            JSON.stringify(result.dinner.protein)
          );
            ...
            case "BREAKFAST":
              {
                ...
                for (let i = 0; i < req.body.veggie.length; i++) {
                  ...
                  if (
                    old_veggie_container.length !== 0 &&
                    old_veggie_container.includes(key[0])
                  ) {
                ...
                for (let i = 0; i < req.body.fruits.length; i++) {
                  ...
                  if (
                    old_fruit_container.length !== 0 &&
                    old_fruit_container.includes(key[0])
                  ) {
                ...
                for (let i = 0; i < req.body.grains.length; i++) {
                  ...
                  if (
                    old_grain_container.length !== 0 &&
                    old_grain_container.includes(key[0])
                  ) {
                ...
                for (let i = 0; i < req.body.protein.length; i++) {
                  ...
                  if (
                    old_protein_container.length !== 0 &&
                    old_protein_container.includes(key[0])
                  ) {
                ...
                temp_val.breakfast.veggie = JSON.parse(
                  JSON.stringify(new_veggie_container)
                );
                temp_val.breakfast.fruits = JSON.parse(
                  JSON.stringify(new_fruit_container)
                );
                temp_val.breakfast.grains = JSON.parse(
                  JSON.stringify(new_grain_container)
                );
                temp_val.breakfast.protein = JSON.parse(
                  JSON.stringify(new_protein_container)
                );
              }
              break;
            case "LUNCH":
          ...
          db.collection("FoodHistory").deleteOne(old_result, (err, result) => {
            if (err) console.log("Error in deleting the old doc");

            db.collection("FoodHistory").insertOne(temp_val, (err, result) => {
              if (err) console.log("Error in updating the new doc");
