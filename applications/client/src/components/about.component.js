            ...
            <div class="row">
              ...
              >
                <div class="icon-box iconbox-blue">
                  ...
                  <h4>
                    <Link to="/prathiba" className="nav-link">
                      Prathiba Ramesh
                    </Link>
                  </h4>
                  <p>Team Leader - Click on the name to know more </p>
              ...
              >
                <div class="icon-box iconbox-orange ">
                  ...
                  <h4>
                    <Link to="/tunni">Tun-Ni Chiang</Link>
                  </h4>
                  <p>Front-end Leader - Click on the name to know more </p>
                </div>
              </div>
              ...
              >
                <SwiperSlide>
                  <div class="testimonial-item">
                    <img
                      src="assets/img/misc/zoom.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>
                      <a href="https://sfsu.zoom.us/j/89849737126?pwd=YmhPUFF1dGFjK1MzM2hzQlM1bVBCZz09">
                        {" "}
                        Team Meeting Link{" "}
                      </a>
                    </h3>
                    ...
                    <p>
                      ...
                      We are meeting on above zoom link on every Wednesday from{" "}
                      <br /> 11 AM - 12 PM
                ...
                <SwiperSlide>
                  <div class="testimonial-item">
                    <img
                      src="assets/img/misc/discord.jpg"
                      class="testimonial-img"
                      alt=""
                    />
                    <h3>
                      <a href="https://discord.com/channels/936451119465500692/936451119465500695">
                        {" "}
